        ...
        case 'catchall-intercepted-(...)':
          ...
          if (hasUnknownParam) {
            fallbackRouteParams.push(
              createFallbackRouteParam(paramName, paramType)
            )
            break
          }
  ...
  if (hadAllParamsGenerated || isRoutePPREnabled) {
    ...
    if (isRoutePPREnabled) {
      ...
      for (const segment of segments) {
        ...
        fallbackRouteParams.push(
          createFallbackRouteParam(segment.paramName, segment.paramType)
        )
      }
        ...
        if (!paramValue) {
          if (isRoutePPREnabled) {
            ...
            for (
              ...
              fallbackRouteParams.push(
                createFallbackRouteParam(
                  pathnameRouteParamSegments[i].paramName,
                  pathnameRouteParamSegments[i].paramType
                )
              )
            }
            break
